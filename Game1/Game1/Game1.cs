...
namespace Game1
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            {
                if (touchCollection[0].Position.X < 960 && touchCollection[0].Position.Y > 540 && touchCollection[0].Position.Y < 810 && ldt != 1)
                    direction = 0;
                else
                    if (touchCollection[0].Position.X < 960 && touchCollection[0].Position.Y > 810 && ldt != 0)
                    direction = 1;
                else
                        if (touchCollection[0].Position.X > 960 && touchCollection[0].Position.Y > 540 && touchCollection[0].Position.Y < 810 && ldt != 3)
                    direction = 2;
                else
                            if (touchCollection[0].Position.X > 960 && touchCollection[0].Position.Y > 810 && ldt != 2)
                    direction = 3;
            }
            ...
            if (touchCollection.Count > 0)//just a loop
            {
                ...
                {
                    if (touchCollection[0].Position.X > 1620 && touchCollection[0].Position.Y < 53)
                        Environment.Exit(0);
                    if (touchCollection[0].Position.X < 244 && touchCollection[0].Position.Y < 50)
                        reset();
                }
            }
